...
class MaestroDataset(object):
    ...
    def __getitem__(self, meta):
       ...
       # Debugging
       #  print(data_dict.keys()) # dict_keys(['waveform', 'onset_roll', 'offset_roll', 'reg_onset_roll',
                                # 'reg_offset_roll', 'frame_roll', 'velocity_roll', 'mask_roll', 'reg_pedal_onset_roll',
                                # 'pedal_onset_roll', 'pedal_offset_roll', 'reg_pedal_offset_roll', 'pedal_frame_roll'])

        # print(data_dict['waveform'].shape)  # (160000,)
...
class Sampler(object):
    def __init__(self, hdf5s_dir, split, segment_seconds, hop_seconds, 
        ...
        n = 0
        print("self.hop_seconds", self.hop_seconds)
    ...
    def __iter__(self):
        while True:
            ...
            i = 0
            print("Total iterations", len(self.segment_indexes))
